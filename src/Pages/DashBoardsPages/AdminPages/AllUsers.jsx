            ...
            <tbody>
              {users.map((user, index) => (
                ...
                >
                  ...
                  <td>{user.name}</td>
                  <td>{user.email}</td>
                  <td className="font-bold  gap-2 uppercase">{user.role} <span><button  className="btn ml-2 btn-circle"><FaUserShield className="text-xl  text-green-500"></FaUserShield></button></span> </td>
                  <td>
                    <MdPersonRemove
